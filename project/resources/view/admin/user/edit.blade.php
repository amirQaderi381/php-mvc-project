                            ...
                            <form class="row" action="<?= route('admin.user.update',['id'=>$user->id])?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    <fieldset class="form-group">
                                        ...
                                        <input name="first_name" type="text" id="first_name" value="<?= oldOrValue('first_name',$user->first_name)?>" class="form-control <?= errorClass('first-name')?>" >
                                ...
                                <div class="col-md-6">
                                    <fieldset class="form-group">
                                        ...
                                        <img src="<?= asset($user->avatar)?>" alt="" width="200px" height="150px" class="mt-2">
                                    </fieldset>
                                </div>
