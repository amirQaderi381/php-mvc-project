...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 search-wrap">
                    <form action="<?= route('home.search') ?>" class="search-property">
                        <div class="row">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="properties-slider owl-carousel ftco-animate">
                        ...
                        <?php foreach ($latestAds as $latestAdvertise) { ?>

                        <div class="item">
                            <div class="properties">
                                <a href="<?= route('home.ads', [$latestAdvertise->id]) ?>"
                                    class="img d-flex justify-content-center align-items-center"
                                    style="background-image: url('<?= asset($latestAdvertise->image) ?>');">
                                ...
                                <div class="text p-3">
                                    <span
                                        class="status <?= $latestAdvertise->sellStatus() == 'خرید' ? 'sale' : 'rent' ?>"><?= $latestAdvertise->sellStatus() ?></span>
                                    <div class="d-flex">
                                        <div class="one">
                                            <h3><a
                                                    href="<?= route('home.ads', [$latestAdvertise->id]) ?>"><?= $latestAdvertise->title ?></a>
                                            </h3>
                                            <p><?= $latestAdvertise->type() ?></p>
                                        </div>
                                        <div class="two">
                                            <span class="price"><?= $latestAdvertise->amount ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <section class="ftco-section bg-light">
        ...
        <div class="container-fluid">
            <div class="row">
                <?php foreach ($bestAds as $bestAdvertisement) { ?>
                <div class="col-sm col-md-6 col-lg ftco-animate">
                    <div class="properties">
                        <a href="<?= route('home.ads', [$bestAdvertisement->id]) ?>"
                            class="img img-2 d-flex justify-content-center align-items-center"
                            style="background-image: url('<?= asset($bestAdvertisement->image) ?>');">
                            <div class="icon d-flex justify-content-center align-items-center">
                                <span class="icon-search2"></span>
                            </div>
                        </a>
                        <div class="text p-3">
                            <span
                                class="status <?= $bestAdvertisement->sellStatus() == 'خرید' ? 'sale' : 'rent' ?>"><?= $bestAdvertisement->sellStatus() ?></span>
                            <div class="d-flex">
                                <div class="one">
                                    <h3><a
                                            href="<?= route('home.ads', [$bestAdvertisement->id]) ?>"><?= $bestAdvertisement->title ?></a>
                                    </h3>
                            ...
                            <p class="bottom-area d-flex">
                                ...
                                <span class="ml-auto"><i
                                        class="flaticon-bathtub"></i><?= $bestAdvertisement->room ?></span>
                    ...
                    <div class="blog-entry align-self-stretch">
                        ...
                        <div class="text mt-3 d-block">
                            <h3 class="heading mt-3"><a
                                    href="<?= route('home.post', [$post->id]) ?>"><?= $post->title ?></a></h3>
                            <div class="meta mb-3">
                                <div><a
                                        href="#"><?= \Morilog\Jalali\Jalalian::forge($post->created_at)->format('%B %d، %Y') ?></a>
                                </div>
                                <div><a
                                        href="#"><?= $post->user()->first_name . ' ' . $post->user()->last_name ?></a>
                                </div>
