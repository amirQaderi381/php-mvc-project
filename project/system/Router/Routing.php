...
class Routing
{
    ...
    private $method_field; /* define http verbs that used in route */
    private $routes;
    private $values = [];  /* parameters in route like system/2 */
    ...
    {
        //compare currentRoute with reservedRoute in 3 parts : 

        //part1 eg.toplearn.com/
        ...
        /* 
          reservedRoute : article/edit/{id}
          currentRoute : category/edit/2;

          compare item's currentRoute with item's reservedRoute one by one
          for comaparing both item's array with each other , their item's is necessary 
          solves this solution with foreach one of route like currentRoute and
          compare it with reservedRoute by key because both route are index array
