...
Route::get('/ajax-posts', 'HomeController@ajaxLastPosts', 'home.last.posts');
...
Route::get('/register/activation/{token}' , 'Auth\RegisterController@activation','auth.activation');
